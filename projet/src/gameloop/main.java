...
public class main {
	...
	public static void main(String[] args) {
		...
		Hero isaac = new Hero(RoomInfos.POSITION_START, HeroInfos.ISAAC_SIZE, HeroInfos.ISAAC_SPEED, ImagePaths.ISAAC, 6, 1, 0.5, 0.05);
	...
	public static void processNextStep(GameWorld world) {
		Timer.beginTimer();
		StdDraw.clear();
	...
	private static void initializeDisplay() {
		...
		StdDraw.setCanvasSize(RoomInfos.NB_TILES * DisplaySettings.PIXEL_PER_TILE, RoomInfos.NB_TILES * DisplaySettings.PIXEL_PER_TILE);
